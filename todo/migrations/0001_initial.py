    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('level',
                 models.SmallIntegerField(choices=[(1, '普通任务'), (3, '突发紧急任务'), (2, '优先任务'), (0, '不紧急任务')], default=0,
                                          verbose_name='任务重要性')),
                ('expiration_date', models.DateTimeField(blank=True, null=True, verbose_name='任务截止日期')),
                ('status', models.SmallIntegerField(choices=[(1, '进行中'), (2, '已完成'), (3, '已过期'), (0, '未开始')], default=0,
                                                    verbose_name='任务状态')),
                ...
                ('tag', models.SmallIntegerField(
                    choices=[(1, '学习'), (6, '其他'), (2, '饮食'), (4, '休闲'), (0, '运动'), (5, '生活'), (3, '工作')], default=0,
                    verbose_name='标签')),
