# Generated by Django 4.0.6 on 2022-07-30 02:02
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.SmallIntegerField(choices=[(0, '未开始'), (2, '已完成'), (3, '已过期'), (1, '进行中')], default=0, verbose_name='任务状态')),
                ...
                ('tag', models.SmallIntegerField(choices=[(2, '饮食'), (4, '休闲'), (0, '运动'), (3, '工作'), (6, '其他'), (1, '学习'), (5, '生活')], default=0, verbose_name='标签')),
